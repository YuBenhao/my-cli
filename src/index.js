...
program
  ...
  .description(chalk.red('  指定一个模板，初始化项目'))
  .option('-c, --clone', '使用 git clone')
  .option('-n, --npm', '使用 npm 安装')
  .option('-y, --yarn', '使用 yarn 安装')
